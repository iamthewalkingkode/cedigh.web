...
(function($, window, document, undefined) {
    ...
    Owl.prototype.prepare = function(item, index) {
        ...
        if (!event.data) {
            event.data = $('<' + this.settings.itemElement + '/>').addClass(this.options.itemClass).attr('data-index', index + 1).append(item)
        }
...
(function($, window, document, undefined) {
    ...
    Animate.prototype.swap = function() {
        ...
        if (outgoing) {
            ...
            previous.css({
                'left': left + 'px'
            }).addClass('animated owl-animated-out').addClass(outgoing).on($.support.animation.end, clear)
        }
        if (incoming) {
            next.addClass('animated owl-animated-in').addClass(incoming).on($.support.animation.end, clear)
        }
    };
